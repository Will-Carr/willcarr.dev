    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="main" class="col-12 col-md-9">
                ...
                <div id="display-carousel" class="carousel slide rounded-lg border border-info mx-auto my-3" data-ride="carousel">

                    <!-- Indicators -->
                    <ul class="carousel-indicators">
                        <li data-target="#display-carousel" data-slide-to="0" class="active"></li>
                        <li data-target="#display-carousel" data-slide-to="1"></li>
                        <li data-target="#display-carousel" data-slide-to="2"></li>
                    </ul>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <picture>
                                ...
                                <img class="img img-fluid" src="/images/willcarrdev.png" alt="WillCarr.dev" />
                            </picture>
                        </div>
