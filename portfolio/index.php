...
<head>
  ...
  <meta name="keywords" content="willcarr.dev, will carr, william carr, carr, web, website, software, developer, engineer, full-stack, full stack, frontend, front-end, front end, backend, back-end, back end, portfolio, github, linkedin, portfolio, dominos, team lyders, asterisk, konstru, bullseye, bullseye redevelopment, degaetano, carr, degaetano carr, josh green, jgreen">
  <meta name="description" content="Will Carr has contributed to large scale projects within Domino's and Thornton Tomasetti. He has also been contracted to develop numerous sites for business and personal use.">
          ...
          <div class="projects d-flex flex-wrap">
            <div class="project" id="dominos">
              ...
              <a href="/portfolio/dominos/" tabindex="-1">
                <div title="Domino's Pizza" class="project-image rounded-lg border border-info"></div>
              </a>
            </div>
