...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="sidebar-background" class="col-3 vh-100 position-fixed bg-info"></div>
            ...
            <div id="sidebar" class="col-12 col-md-3 d-none d-md-flex flex-column justify-content-between">
