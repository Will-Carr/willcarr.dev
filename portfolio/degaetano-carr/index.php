...
<head>
  ...
  <meta name="keywords" content="willcarr.dev, will carr, william carr, carr, web, website, software, developer, engineer, full-stack, full stack, frontend, front-end, front end, backend, back-end, back end, portfolio, github, linkedin, degaetano, carr, degaetano carr">
  <meta name="description" content="Will Carr developed DeGaetano & Carr LLP's site over the summer of 2018, and continues to maintain it.">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div id="main" class="col-12 col-md-9">
        ...
        <a href="https://degaetanocarr.com" target="_blank" class="text-muted min-link">
        ...
        <div id="project-links">
          <div class="mt-4 d-flex justify-content-between flex-wrap">
            ...
            <a href="/portfolio/dominos/" class="btn btn-clear d-flex justify-content-between">
              <span class="mr-1 arrow-text">Domino's</span>
